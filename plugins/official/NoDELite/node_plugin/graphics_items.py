...
class ConnectionItem(QtWidgets.QGraphicsPathItem):
    ...
    def __init__(self, source_port=None, target_port=None, temp_end_pos=None, route_points=None, preview_mode=False):
        super().__init__()
        ...
        self._cached_connection_kind = None
...
class NodeItem(QtWidgets.QGraphicsItem):
    ...
    def paint(self, painter, option, widget=None):
        ...
        painter.drawRect(0, TITLE_HEIGHT - NODE_CORNER_RADIUS, self.width, NODE_CORNER_RADIUS)
