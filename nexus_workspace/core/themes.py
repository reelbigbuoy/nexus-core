...
def _balanced_theme(theme_id, display_name, category, is_dark, palette):
    ...
    overrides = {
        ...
        'connection_exec': palette.get('connection_exec', palette.get('wire_exec', accent_alt)),
        'connection_data': palette.get('connection_data', palette.get('wire_data', port_output)),
        'wire': palette.get('wire', connection),
        'wire_exec': palette.get('wire_exec', palette.get('connection_exec', accent_alt)),
        'wire_data': palette.get('wire_data', palette.get('connection_data', port_output)),
